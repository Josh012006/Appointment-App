    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        try {
            ...
            if(!modifying) {
                ...
                if(IsValid) {
                    setIsLoading(true);
                    router.push(`/userpage/med/profile/#profileForm`);
    ...
    return (
        <div className="p-3">
            ...
            <form onSubmit= {handleSubmit} className="flex flex-col m-auto w-4/5 lg:w-1/4" id="profileForm">
                ...
                <ProfileInput ReadOnly={true} Type="text" Placeholder="Spécialité" Label="Spécialité (s)" ID="specialty" Value={user?.speciality?.join(', ')?? ""} />
                <ProfileInput ReadOnly={true} Type="text" Placeholder="Genre" Label="Genre" ID="gender" Value={user?.gender?? ""} />
